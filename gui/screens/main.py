...
class UserInfoFrame(ctk.CTkFrame):
    def __init__(self, parent, app_instance):
        ...
        self.logout_icon = ctk.CTkButton(
            ...
            corner_radius=100,
            width=0,
            command=lambda: self.logout_transition(parent)
        )
    ...
    def logout_transition(self, parent):
        user_decision = askyesno('Logout', message='Are you sure you want to log out of this account?')

        if user_decision:
            account_manager.set_account(dict())  # Set to empty dictionary
            TransitionScreen(parent.master, 'LoginScreen', 'Logging Out...', 'Thank You!', 1500)
...
class FeaturePanelsFrame(ctk.CTkFrame):
    def __init__(self, parent, app_instance):
        ...
        self.deposit_panel.grid(row=0, column=0, padx=(panel_spacing, panel_spacing // 2),
                                pady=(panel_spacing, panel_spacing // 2), sticky='nsew')
        ...
        self.withdraw_panel.grid(row=0, column=1, padx=(panel_spacing // 2, panel_spacing // 2),
                                 pady=(panel_spacing, panel_spacing // 2), sticky='nsew')
        ...
        self.transfer_panel.grid(row=0, column=2, padx=(panel_spacing // 2, panel_spacing),
                                 pady=(panel_spacing, panel_spacing // 2), sticky='nsew')
        ...
        self.fd_calculator_panel.grid(row=1, column=0, padx=(panel_spacing, panel_spacing // 2),
                                      pady=(panel_spacing // 2, panel_spacing), sticky='nsew')
        ...
        self.transactions_panel.grid(row=1, column=1, padx=(panel_spacing // 2, panel_spacing // 2),
                                     pady=(panel_spacing // 2, panel_spacing), sticky='nsew')
        ...
        self.e_statement_panel.grid(row=1, column=2, padx=(panel_spacing // 2, panel_spacing),
                                    pady=(panel_spacing // 2, panel_spacing), sticky='nsew')
